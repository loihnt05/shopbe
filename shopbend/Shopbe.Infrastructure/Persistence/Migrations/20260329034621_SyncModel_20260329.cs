...
{
    /// <inheritdoc />
    public partial class SyncModel_20260329 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFeeId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shipments_ShippingFees_ShippingFeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantAttributes", x => new { x.VariantId, x.AttributeValueId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAddresses_DeletedAt",
                table: "UserAddresses",
                column: "DeletedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_DeletedAt",
                table: "ProductVariants",
                column: "DeletedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdempotencyKeys_Key_EntityType",
                table: "IdempotencyKeys",
                columns: new[] { "Key", "EntityType" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewImages_ReviewId_SortOrder",
                table: "ReviewImages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_ShippingFeeId",
                table: "Shipments",
